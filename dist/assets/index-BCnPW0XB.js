import{O as c,P as r}from"./index-NVPnfjv5.js";import{n}from"./class-map-BfYkPkqt.js";import{o as h}from"./if-defined-Cb88xRGe.js";import{e as m,n as b}from"./index-C42XPWu1.js";import{c as x,r as f,e as $,a as g}from"./index-CLkz0d9K.js";const w=x`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var i=function(t,a,s,u){var p=arguments.length,o=p<3?a:u===null?u=Object.getOwnPropertyDescriptor(a,s):u,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,a,s,u);else for(var d=t.length-1;d>=0;d--)(l=t[d])&&(o=(p<3?l(o):p>3?l(a,s,o):l(a,s))||o);return p>3&&o&&Object.defineProperty(a,s,o),o};let e=class extends c{constructor(){super(...arguments),this.inputElementRef=m(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return r` <div class="wui-input-text-container">
