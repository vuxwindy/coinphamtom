// Stable Wallet System - COINPAYOT NFT
// Hệ thống kết nối wallet ổn định với nhiều cách connect

console.log('🔗 Stable Wallet System loaded');

class StableWalletSystem {
    constructor() {
        // Configuration
        this.config = {
            ppoContract: {
    ...
    async init() {
        console.log('🚀 Initializing Stable Wallet System...');
        ...
        try {
            ...
            console.log('✅ Stable Wallet System initialized');
            
        } catch (error) {
            console.error('❌ Error initializing Stable Wallet System:', error);
        }
    }
        ...
        modal.innerHTML = `
            <div class="wallet-modal-content">
                <div class="wallet-modal-header">
                    ...
                    <button class="wallet-modal-close" onclick="this.closest('.wallet-modal').remove()">&times;</button>
                </div>
                ...
                <div class="wallet-modal-footer">
                    <p class="wallet-modal-help">Don't have a wallet? <a href="#" onclick="window.open('https://metamask.io/download/', '_blank')">Learn more</a></p>
                </div>
            </div>
        `;
...
const stableWallet = new StableWalletSystem();

// Make it globally available
window.stableWallet = stableWallet;
window.StableWalletSystem = StableWalletSystem;

console.log('🎯 Stable Wallet System ready!');
